...
-- Allow public read/write own record
...
-- 2. TRANSACTIONS (from blockchain sync)
-- ============================================
...
CREATE POLICY "Service write transactions" ON transactions FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Service write blocks" ON blocks FOR INSERT WITH CHECK (true);
...
CREATE POLICY "Service write chain_stats" ON chain_stats FOR INSERT WITH CHECK (true);


-- 5. NFT ASSETS (optional)
-- ============================================
...
CREATE POLICY "Users can read nfts" ON nfts FOR SELECT USING (true);
